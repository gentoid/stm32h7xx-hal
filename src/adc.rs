        ...
        $(
            ...
            impl Adc<$ADC, Enabled> {
                ...
                fn set_chan_smp(&mut self, chan: u8) {
                    ...
                    if chan <= 9 {
                        self.rb.smpr1().modify(|_, w| match chan {
                            0 => unsafe { w.smp0().bits(t) },
                            1 => unsafe { w.smp1().bits(t) },
                            2 => unsafe { w.smp2().bits(t) },
                            3 => unsafe { w.smp3().bits(t) },
                            4 => unsafe { w.smp4().bits(t) },
                            5 => unsafe { w.smp5().bits(t) },
                            6 => unsafe { w.smp6().bits(t) },
                            7 => unsafe { w.smp7().bits(t) },
                            8 => unsafe { w.smp8().bits(t) },
                            9 => unsafe { w.smp9().bits(t) },
                            _ => unreachable!(),
                        });
                    } else {
                        self.rb.smpr2().modify(|_, w| match chan {
                            10 => unsafe { w.smp10().bits(t) },
                            11 => unsafe { w.smp11().bits(t) },
                            12 => unsafe { w.smp12().bits(t) },
                            13 => unsafe { w.smp13().bits(t) },
                            14 => unsafe { w.smp14().bits(t) },
                            15 => unsafe { w.smp15().bits(t) },
                            16 => unsafe { w.smp16().bits(t) },
                            17 => unsafe { w.smp17().bits(t) },
                            18 => unsafe { w.smp18().bits(t) },
                            19 => unsafe { w.smp19().bits(t) },
                            _ => unreachable!(),
                        });
                    }
                }
                ...
                fn start_conversion_common(&mut self, chan: u8) {
                    ...
                    // Set LSHIFT[3:0]
                    self.rb.cfgr2().modify(|_, w| unsafe { w.lshift().bits(self.get_lshift().value()) });
                    ...
                    where PIN: embedded_hal_02::adc::Channel<$ADC, ID = u8>,
                {
                    ...
                    self.rb.cfgr().modify(|_, w| unsafe { w.dmngt().bits(match mode {
