...
impl Rcc {
    ...
    pub fn freeze(
        ...
        #[cfg(feature = "log")]
        {
            ...
            #[cfg(not(any(feature = "stm32h753", feature = "stm32h753v")))]
            debug!(
            ...
            #[cfg(any(feature = "stm32h753", feature = "stm32h753v"))]
            debug!(
                "PLL2DIVR register: DIVN2={:#x} DIVP12={:#x} DIVQ2={:#x} DIVR2={:#x}",
                pll2divr.divn2().bits(),
                pll2divr.divp12().bits(),
                pll2divr.divq2().bits(),
                pll2divr.divr2().bits(),
            );
